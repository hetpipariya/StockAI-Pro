...
from ..inference.feature_engineering import compute_features
from .candle_builder import candle_builder_15m
...
class LiveExecutor:
    ...
    def _load_model(self):
        ...
        try:
            from ..inference.models import _ensemble_model, load_models

            if not _ensemble_model:
                load_models()
            from ..inference.models import _ensemble_model as m
            from ..inference.models import _features_list as f
            from ..inference.models import _scaler as s
