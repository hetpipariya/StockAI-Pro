...
from stockai_shared.services.instrument_service import refresh_instruments_daily
from app.ws.handler import auto_start_ws, get_or_create_ws_connector
from stockai_shared.cache.redis_client import distributed_job_lock
...
async def sync_broker_positions():
    ...
    async with distributed_job_lock("sync_broker_positions", lock_ttl_seconds=50) as acquired:
        if not acquired:
            ...
            return
        from stockai_shared.config import config as _cfg
