...
from stockai_shared.core.database import healthcheck as db_healthcheck
...
from app.ws.handler import (get_last_tick_age_seconds, get_ws_state,
                                   is_ws_streaming, setup_websocket_routes)
from app.ws.relay import get_client_count
...
async def health_ready():
    ...
    from stockai_shared.cache.redis_client import get_redis, is_degraded_mode
    from app.ws.handler import get_ws_state
